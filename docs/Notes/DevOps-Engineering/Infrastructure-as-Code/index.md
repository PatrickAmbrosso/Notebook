...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Configuration** | **Infrastructure:** Configuration refers to the settings and parameters that define how a specific component or system operates. It includes details like network configurations, software settings, and security policies.<br><br>**IaC:** In the context of IaC, configuration refers to defining the desired state of infrastructure components and services through code or configuration files. IaC tools use these configurations to automate the setup and maintenance of infrastructure resources.<br><br> **Tools:** [Ansible](Ansible.md#), [Chef](Chef.md#), [Terraform](./Terraform.md#), [CloudFormation](AWS%20CloudFormation.md#), [Puppet](Puppet.md#)                                             |
